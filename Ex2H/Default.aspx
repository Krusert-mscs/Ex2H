<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Ex2H._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox8" runat="server" Width="119px">November 1, 2019</asp:TextBox>
                ...
                <asp:TextBox ID="TextBox10Result" runat="server" Enabled="False" Width="121px"></asp:TextBox>
            </div>
            <div class="form-group">
